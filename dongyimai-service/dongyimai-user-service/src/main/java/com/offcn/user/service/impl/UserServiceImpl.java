...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public void createSmsCode(String phone) {
        ...
        String code = (long) (new Random().nextDouble() * 1000000)+"";
        stringRedisTemplate.boundHashOps("smsHash").put(phone,code);
        ...
        rabbitTemplate.convertAndSend("dongyimai.sms.queue",map);//队列接收到消息，异步发送短信
    }

    @Override
    public boolean checkSmsCode(String mobile, String code) {

        Object redis_code = stringRedisTemplate.boundHashOps("smsHash").get(mobile);
