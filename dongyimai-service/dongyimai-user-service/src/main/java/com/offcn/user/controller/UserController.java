...
//         调用Username实现根据主键查询User
    ...
    public Result sendCode(String phone){
        if (!PhoneFormatCheckUtils.isPhoneLegal(phone)) {
            return new Result(false,StatusCode.ERROR,"号码有误");
        }
        try {
     ...
     * @return
     */
    @RequestMapping(value = "/login")//HttpServletResponse response
...
//             设置令牌信息
            ...
            return new Result(false, StatusCode.LOGINERROR, "密码有误");
        }
...
//    }
    ...
    public Result add(@RequestBody User user,String smscode){
        boolean checkSmsCode = userService.
