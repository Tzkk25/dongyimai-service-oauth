...
public class ContentController {
    ...
    @ApiOperation(
            value = "根据categoryId查询广告集合",
            notes = "根据categoryId查询广告集合",
    ...
    public Result<List<Content>> findByCategory(@PathVariable(name = "id") Long id) {
        List<Content> byCategory = contentService.findByCategory(id);
        return new Result<List<Content>>(true, StatusCode.OK, "根据分类id查询成功", byCategory);
    }
