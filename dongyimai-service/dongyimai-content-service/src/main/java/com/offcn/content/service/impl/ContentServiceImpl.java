...
public class ContentServiceImpl extends ServiceImpl<ContentMapper, Content> implements ContentService {
    ...
    public List<Content> findByCategory(Long id) {
        ...
        contentQueryWrapper.eq("category_id", id);
        contentQueryWrapper.eq("status", "1");

        contentQueryWrapper.orderByAsc("sort_order");

        List<Content> list = this.list(contentQueryWrapper);
        return list;
    }
