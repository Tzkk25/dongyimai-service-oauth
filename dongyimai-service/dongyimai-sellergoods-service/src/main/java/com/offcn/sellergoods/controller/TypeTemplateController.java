...
public class TypeTemplateController {
    ...
    public Result<PageResult<TypeTemplate>> findPage(@RequestBody(required = false)
                                                     @ApiParam(name = "TypeTemplate对象",value = "传入JSON数据",required = false)
                                                             TypeTemplate typeTemplate, @PathVariable  int page, @PathVariable  int size){
