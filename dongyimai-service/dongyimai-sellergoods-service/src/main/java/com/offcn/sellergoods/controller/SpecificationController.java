...
public class SpecificationController {
    ...
    public Result add(@RequestBody
                      @ApiParam(name = "SpecEntity对象",value = "传入规格和规格选项集合的JSON数据",required = true)
     ...
     * @return
     */
    @ApiOperation(value = "Specification根据ID查询",notes = "根据规格id查询组合对象",tags = {"SpecificationController"})
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Long")
    @GetMapping("/{id}")
    public Result<SpecEntity> ById(@PathVariable Long id){
    ...
    public List<Map> findSpecList(@PathVariable("id") Long typeTemplateId) {
        return specificationService.findSpecList(typeTemplateId);
    }
